...
public class LocalEmailAuthStrategy implements AuthenticationStrategy {
    ...
    public LocalEmailAuthStrategy(UserRepository repository, PasswordEncoder passwordEncoder) {
    ...
    public UserEntity authenticate(String credential, String password) {
        UserEntity user = repository.findByEmailIgnoreCase(credential.trim())
